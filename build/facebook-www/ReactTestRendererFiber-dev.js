 ...
 *
 * @noflow
 * @providesModule ReactTestRendererFiber-dev
 */
...
function findCurrentFiberUsingSlowPath(fiber) {
  ...
  // unmounted.
  invariant(a.tag === HostRoot$3, 'Unable to find node on an unmounted component.');
...

{
  var _require$2 = ReactTypeOfWork,
      HostRoot$4 = _require$2.HostRoot,
...
var findCurrentUnmaskedContext$1 = function (fiber) {
  ...
  invariant(isFiberMounted(fiber) && fiber.tag === ClassComponent$2, 'Expected subtree parent to be a mounted class component');
...
function ChildReconciler(shouldClone, shouldTrackSideEffects) {
  ...
  function reconcileChildFibers(returnFiber, currentFirstChild, newChild, priority) {
    ...
    var disableNewFiberFeatures = ReactFeatureFlags$1.disableNewFiberFeatures;
...
var ReactFiberClassComponent = function (scheduleUpdate, getPriorityContext, memoizeProps, memoizeState) {
  ...
  function mountClassInstance(workInProgress, priorityLevel) {
    ...
    if (ReactFeatureFlags$2.enableAsyncSubtreeAPI && workInProgress.type != null && workInProgress.type.unstable_asyncUpdates === true) {
...
var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleUpdate, getPriorityContext) {
  ...
  */
  ...
  function beginFailedWork(current, workInProgress, priorityLevel) {
    invariant(workInProgress.tag === ClassComponent$7 || workInProgress.tag === HostRoot$7, 'Invalid type of work. This error is likely caused by a bug in React. ' + 'Please file an issue.');
...
var ReactFiberCommitWork = function (config, captureError) {
  ...
  function isHostParent(fiber) {
    return fiber.tag === HostComponent$9 || fiber.tag === HostRoot$9 || fiber.tag === HostPortal$6;
  }
...
var ReactFiberReconciler = function (config) {
  ...
  function scheduleTopLevelUpdate(current, element, callback) {
    ...
    // `renderAsync` API.
    var forceAsync = ReactFeatureFlags.enableAsyncSubtreeAPI && element != null && element.type != null && element.type.unstable_asyncUpdates === true;
