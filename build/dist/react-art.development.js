/**
 * react-art.development.js v16.0.0-alpha.13
 */

(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('art/modes/current'), require('art/modes/fast-noSideEffects'), require('art/core/transform'), require('react')) :
	typeof define === 'function' && define.amd ? define(['art/modes/current', 'art/modes/fast-noSideEffects', 'art/core/transform', 'react'], factory) :
	(global.ReactART = factory(null,null,null,global.React));
}(this, (function (art_modes_current,art_modes_fastNoSideEffects,art_core_transform,react) { 'use strict';
  ...
  function warnOnInvalidKey(child, knownKeys) {
    {
      ...
      switch (child.$$typeof) {
        ...
        case REACT_PORTAL_TYPE:
          ...
          warning$8(false, 'Encountered two children with the same key, ' + '`%s`. Child keys must be unique; when two children share a key, ' + 'only the first child will be used.%s', key, getCurrentFiberStackAddendum$1());
          break;
        default:
          break;
      }
...
var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleUpdate, getPriorityContext) {
  ...
  */
  ...
  function beginFailedWork(current, workInProgress, priorityLevel) {
    invariant_1(workInProgress.tag === ClassComponent$6 || workInProgress.tag === HostRoot$6, 'Invalid type of work. This error is likely caused by a bug in React. ' + 'Please file an issue.');
...
var require$$0$3 = ( current$2 && current ) || current$2;
...
var require$$1$1 = ( fastNoSideEffects$2 && fastNoSideEffects ) || fastNoSideEffects$2;
...
require$$0$3.setCurrent(
// Change to 'art/modes/dom' for easier debugging via SVG
require$$1$1);

var Mode = require$$0$3;
...
var ARTRenderer = ReactFiberReconciler({
  ...
  createInstance: function (type, props, internalInstanceHandle) {
    ...
    invariant_1(instance, 'ReactART does not support the type "%s"', type);
  ...
  insertBefore: function (parentInstance, child, beforeChild) {
    invariant_1(child !== beforeChild, 'ReactART: Can not insert node before itself');
