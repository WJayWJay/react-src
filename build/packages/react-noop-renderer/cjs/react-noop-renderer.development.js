...
var jestMatchers = require('jest-matchers');
...
function comparePriority(a, b) {
  ...
  if ((a === TaskPriority$1 || a === SynchronousPriority) && (b === TaskPriority$1 || b === SynchronousPriority)) {
    return 0;
  }
...
var TaskPriority$2 = ReactPriorityLevel.TaskPriority;
...
var ReactFiberScheduler = function (config) {
  ...
  function commitAllWork(finishedWork) {
    ...
    priorityContext = TaskPriority$2;
    ...
    if ('development' !== 'production' && ReactFiberInstrumentation$2.debugTool) {
  ...
  function clearErrors() {
    ...
    while (capturedErrors !== null && capturedErrors.size && nextUnitOfWork !== null && nextPriorityLevel !== NoWork$2 && nextPriorityLevel <= TaskPriority$2) {
  ...
  function workLoopSync(minPriorityLevel) {
    ...
    while (nextUnitOfWork !== null) {
      ...
      if (nextUnitOfWork === null) {
        ...
        clearErrors();
        // The priority level may have changed. Check again.
        if (nextPriorityLevel === NoWork$2 || nextPriorityLevel > minPriorityLevel || nextPriorityLevel > TaskPriority$2) {
          // The priority level does not match.
          break;
        }
      }
  ...
  function workLoop(minPriorityLevel, deadline) {
    ...
    if (nextPriorityLevel !== NoWork$2 && nextPriorityLevel <= minPriorityLevel) {
      if (nextPriorityLevel <= TaskPriority$2) {
            ...
            switch (priorityLevel) {
              case SynchronousPriority$1:
                ...
                if (isUnbatchingUpdates) {
                  ...
                  performWork(TaskPriority$2, null);
                }
                break;
              case TaskPriority$2:
  ...
  function scheduleErrorRecovery(fiber) {
    scheduleUpdate(fiber, TaskPriority$2);
  }
...
var ReactNoop = {
  ...
  flushThrough: function (expected) {
    ...
    jestMatchers(actual).toEqual(expected);
  },
...
var ReactNoopEntry = ReactNoop;

module.exports = ReactNoopEntry;
